...
if [[ "$ASESR" != 0 ]]
then 
   echo -e ""$E"Sem internet vagabundo!"
   exit
fi
...
sleep 1
echo -e ""$G"Baixando arquivos, tenha calma vadia..."
sleep 1
...
echo -e ""$E"Deu merda menoh, n foi possivel instalar!"
exit
fi
...
sleep 1
echo -e ""$S"BAIXADO KRLH KKKKKKKKKK, BORA SPAMAR!"
sleep 1
